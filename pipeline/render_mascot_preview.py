"""Render the short's atlas-sprite story beats for inspection.

blender --background Purrcilla_Dixon_Dage_Animated_Short_Mascot_Sprites.blend \
  --python pipeline/render_mascot_preview.py
"""
...
destination = root / "preview_frames" / "mascot_sheets"
...
for frame in (1, 85, 122, 132, 145, 210, 258):
