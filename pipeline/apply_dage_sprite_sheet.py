"""Historical 7x10 Dage patch migration for a mascot short or Episode 02.

blender --background INPUT.blend --python pipeline/apply_dage_sprite_sheet.py

This utility is not a converter for the current 8x11 Dage sheet. The old
source must be restored before this historical migration can run. It removes
the earlier procedural bowtie/chin overlay and its action keys, then saves.
"""
...
from pipeline.dage_neck_patch import MARK_VERSION
